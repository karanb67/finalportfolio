...
import { cn } from "@/utils/cn"; // Make sure this utility function is defined correctly.
...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
    setTransform("translate(-50%,-50%) scale(0.8)");
  };
  const onMouseLeave = () => {
    setTransform("translate(-50%,-50%) scale(1)"); // Fix the scale function here
  };
